...
const GAS_WEB_APP_URL = "https://script.google.com/macros/s/AKfycbxakTZpq0tDo8VtxvfkVY6ldVTW4YbKrQHNh61Ug6ABeyFG36B1s1K3l_LR3gXkWUXBYw/exec"; 
...
const getInitialMockSettings = (): AppSettings => {
  const defaultSettings: AppSettings = {
    namaSekolah: "SD Inpres Lengke",
    alamat: "Lengke (poros Mamuju - Palu)",
    telepon: "+62 812-2535-8689",
    email: "info@sdinpreslengke.sch.id",
    ...
    sambutanKepalaSekolah: "Selamat datang di website resmi PPDB SD Inpres Lengke. Kami berkomitmen untuk memberikan pelayanan pendidikan terbaik bagi putra-putri Anda. Mari bergabung bersama kami untuk mencetak generasi penerus bangsa yang cerdas, berakhlak mulia, dan berprestasi.",
